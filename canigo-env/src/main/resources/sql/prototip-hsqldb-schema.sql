...
drop index account_category if exists;
drop index account_product if exists;
...
create table account (
	...
	is_lower18 varchar(1),
	password varchar(80) not null,    	
    preferred_category varchar(10) not null,
    preferred_product varchar(10) not null,
